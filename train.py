...
def main():
    ...
    data_transform = {
        "train": transforms.Compose([transforms.Grayscale(num_output_channels=1), # Convert to grayscale
    ...
    DATA_SET_PATH = '/kaggle/input/adni1-3yr-1-5t-3244samples-axial-25'
